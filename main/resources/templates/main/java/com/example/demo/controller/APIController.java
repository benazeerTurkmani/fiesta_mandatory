...
public class APIController {
    ...
    public ResponseEntity<Courses> newCourse(Courses courses, Model model){
    ...
    public ResponseEntity newAdministrator(Administrator administrator){
    ...
    public ResponseEntity newStudyProgramme(StudyProgramme StudyProgramme){
